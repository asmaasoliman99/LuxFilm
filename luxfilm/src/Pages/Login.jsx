...
const Login = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[var(--bg-primary)] flex flex-col items-center justify-center overflow-hidden">
      {/* Gradient Background */}
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        {/* Form Card */}
        <div className="bg-[var(--bg-secondary)]/40 backdrop-blur-xl border border-[var(--accent)]/30 rounded-2xl p-8 shadow-2xl">
          ...
          {error && (
            <div className="mb-6 p-4 bg-[var(--error-red)]/20 border border-[var(--error-red)] rounded-lg flex items-start gap-3">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative">
              ...
              <div
                className={`flex items-center bg-white/10 border rounded-lg px-4 py-3 focus-within:bg-white/15 transition-all duration-300 ${errors.email ? "border-[var(--error-red)] focus-within:border-[var(--error-red)]" : "border-white/20 focus-within:border-[var(--accent)]/60"}`}
              >
            ...
            <div className="relative">
              ...
              <div
                className={`flex items-center bg-white/10 border rounded-lg px-4 py-3 focus-within:bg-white/15 transition-all duration-300 ${errors.password ? "border-[var(--error-red)] focus-within:border-[var(--error-red)]" : "border-white/20 focus-within:border-[var(--accent)]/60"}`}
              >
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer text-gray-400 hover:text-white transition">
                <input
                  type="checkbox"
                  className="w-4 h-4 bg-white/10 border border-white/20 rounded cursor-pointer accent-[var(--accent)]"
                />
                {t("rememberMe")}
              </label>
              <a
                href="#"
                className="text-[var(--accent)] hover:text-[#A3485A] transition font-medium"
              >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[var(--accent)] to-[#662222] hover:from-[#A3485A] hover:to-[#7d3535] text-white font-bold py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2"
            >
              {loading ? (
          ...
          <Link to="/register">
            <button
              type="button"
              className="w-full border-2 border-[var(--accent)] text-white font-bold py-3 px-4 rounded-lg hover:bg-[var(--accent)] transition-all duration-300"
            >
              {t("createAccountBtn")}
            </button>
          </Link>
