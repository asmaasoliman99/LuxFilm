...
const WishlistPage = () => {
    ...
    return (
      <div className="min-h-screen bg-[var(--bg-primary)] flex flex-col items-center justify-center px-6 text-[var(--text-primary)]">
        ...
        <p className="text-gray-400 text-center mb-8 max-w-md text-sm leading-relaxed">
          {t("wishlistEmptyHint")}{" "}
          <Heart size={14} className="inline text-[#842A3B]" />
        </p>
        <button
          onClick={() => navigate("/")}
          className="px-8 py-3 bg-gradient-to-r from-[#842A3B] to-[#662222] text-white font-bold rounded-lg hover:from-[#A3485A] hover:to-[#7d3535] transition-all duration-300 hover:scale-105"
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] pt-24 pb-20 px-6 md:px-12">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-10">
        <div>
          ...
          <p className="text-gray-400 ml-11">
            {wishlistCount}{" "}
            {wishlistCount === 1 ? t("movieSavedSingle") : t("moviesSaved")}
          </p>
        </div>
          ...
          >
            ...
            <div className="relative aspect-[2/3] overflow-hidden">
              <img
                ...
                onError={(e) => {
                  e.target.src =
                    "https://via.placeholder.com/300x450/1c1c1c/666?text=No+Image";
                }}
              />
              ...
              >
                <Heart
                  size={12}
                  className="text-[#842A3B] fill-[#842A3B] group-hover:text-white"
                />
              </button>
            </div>
